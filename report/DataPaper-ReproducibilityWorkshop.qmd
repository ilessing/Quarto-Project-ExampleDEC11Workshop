...
All analyses were conducted in R in the RStudio IDE, using the packages Tidyverse ([@wickham2019]), string (**add citation here**), BayesFactor and patchwork.
